...
export default function Navbar(){
    ...
    return <div className="flex flex-row min-w-full min-h-5 py-3 bg-stone-800 z-1000 fixed top-0">
        <svg
        ...
        <svg 
            className="max-w-6 ml-5 mb-1 hover:cursor-pointer hover:opacity-75"
            onClick={() => {
                setInput("");
                setScreenState("home")
            }}
